...
1. Mapper schreiben (Skript/ETL), das die Daten in ein MII-PRO-konformes FHIR-Bundle umwandelt:
...
1. Validierung gegen PCOR-MII Container (lokal oder zentral):`POST /\$validate`
1. Wenn 0 errors: POST des Bundles an den Empfänger-Server
