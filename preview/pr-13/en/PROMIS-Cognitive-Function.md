...
[**`pcor-mii-exa-promis-cognitive-function-response`**](QuestionnaireResponse-pcor-mii-exa-promis-cognitive-function-response.md) — vollständige Antwort eines hypothetischen Patienten über alle 4 Items, konform zum [`MII PR PRO QuestionnaireResponse`-Profil](https://simplifier.net/packages/de.medizininformatikinitiative.kerndatensatz.pros/2026.4.1) (`meta.profile`: `mii-pr-pro-questionnaire-response|2026.4.1`).
...
**Auto-generiert aus `mii-qst-pro-promis-cognitive-function-sf4a` v2026.7.0 (de.medizininformatikinitiative.kerndatensatz.pros).**
