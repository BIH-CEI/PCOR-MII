# EXPECT (Verlaufserwartung) - PCOR-MII Implementation Guide v0.2.0

## EXPECT (Verlaufserwartung)
...
EXPECT ist **kein publiziertes, standardisiertes Instrument**. Die DIZ-Implementierungsliste PCOR-MII führt es als „3 Einzelitems (Numerische Rating-Skala), kein standardisierter Fragebogen"; Entwicklungs- und Übersetzungspaper sind mit „NA" vermerkt. Die Items stammen direkt aus dem Item Level Dictionary (Entität PSS, Kategorie DCH) und werden in PCOR-MII gepflegt — nicht im MII-PRO-Modul. Erhoben werden sie nur im Szenario [PSS](PSS.md).

### Artefakte

* **Fragebogen:** [Questionnaire-EXPECT](Questionnaire-EXPECT.md)
...
1. Sie sind**nicht gleichgerichtet**: Bei`EXPECT_01`und`EXPECT_02`ist ein hoher Wert ungünstig, bei`EXPECT_03`günstig. Ein Summenwert wäre ohne Umpolung inhaltlich falsch — und da keine Publikation vorliegt, gibt es für eine Umpolungsregel keine Grundlage.
