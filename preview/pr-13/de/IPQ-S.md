# IPQ-S (Ursachenzuschreibung) - PCOR-MII Implementation Guide v0.2.0

## IPQ-S (Ursachenzuschreibung)
...
Die Frage stammt aus dem Item Level Dictionary (Entität PSS, Kategorie DCH, Item `IPQ_S1`) und wird in PCOR-MII gepflegt — nicht im MII-PRO-Modul. Erhoben wird sie nur im Szenario [PSS](PSS.md).
...
* **Fragebogen:** [Questionnaire-IPQS](Questionnaire-IPQS.md)
