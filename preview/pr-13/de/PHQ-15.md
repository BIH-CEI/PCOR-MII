...
PCOR-MII referenziert den im MII PRO-Modul gepflegten Questionnaire — kein eigener Nachbau. Er kommt über die Paket-Abhängigkeit `de.medizininformatikinitiative.kerndatensatz.pros` (2026.7.0) mit; der Score wird als `Observation` abgelegt (LOINC `70273-8`, Summenscore 0–30 mit Kroenke-Schweregraden 0–4 / 5–9 / 10–14 / ≥15). Die vollständige Spezifikation (Items, Antwortoptionen, Scoring-Logik) ist im MII PRO-Modul gepflegt (Paket 2026.7.0) und wird hier bewusst nicht dupliziert; eine eigene Doku-Seite im veröffentlichten MII-PRO-IG folgt mit dessen nächster Publikation.
...
Das MII PRO-Modul liefert ein vollständiges QR-Beispiel mit — [`mii-exa-pro-phq-15-response`](https://simplifier.net/packages/de.medizininformatikinitiative.kerndatensatz.pros/2026.7.0) (Upstream, Simplifier). Die Pflege erfolgt zentral im MII PRO-Modul und wird hier bewusst nicht dupliziert.

### Quellen

* [MII PRO Package 2026.7.0 (Simplifier)](https://simplifier.net/packages/de.medizininformatikinitiative.kerndatensatz.pros/2026.7.0)
