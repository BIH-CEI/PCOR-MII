This page gives an overview of the questionnaires defined in the PCOR-MII Implementation Guide. The full, machine-readable definitions can be found under [Artifacts](artifacts.html).

### Overview

| Questionnaire | Description | Status |
|---|---|---|
| [PCOR Example Questionnaire](Questionnaire-PcorExampleQuestionnaire.html) | Template for capturing patient-reported information | draft |
...
Details on completion and evaluation are provided under [Implementation](Implementation.html).
