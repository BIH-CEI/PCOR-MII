Der **GAD-7** (*Generalized Anxiety Disorder Scale-7*, Spitzer et al. 2006) erfasst **Ängstlichkeit** über sieben Items mit 14-Tage-Recall und vierstufiger Häufigkeitsskala (0 = überhaupt nicht … 3 = beinahe jeden Tag), Summenscore 0–21. Er gehört zur [PHQ-Familie](PHQ.html): in der deutschen Fassung ist er Block 5 des PHQ-D.
...
Erhoben wird der GAD-7 in **allen drei Entitäten** (PSS, AN, NTx) — siehe [Instrumente](Instrumente.html).
...
- Wer GAD-7 und weitere PHQ-Instrumente derselben Person gemeinsam verarbeitet, muss die geteilten `linkId`s berücksichtigen; siehe [PHQ-Übersicht](PHQ.html).
