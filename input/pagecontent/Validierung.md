...
- [`pcor-mii-exa-example-response`](QuestionnaireResponse-pcor-mii-exa-example-response.html)
...
Für den Datenaustausch in der [50-First-Patients Pilot-Kohorte](Implementation.html) wird empfohlen: jeder Sender validiert seine QRs lokal **vor** dem Versenden, und jeder Empfänger validiert nochmal beim Eingang.
